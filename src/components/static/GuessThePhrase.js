  ...
  return (
    <div>
      <div className="case__header">
        <div className="case__header__background case__header__background--game" />
        ...
        <div className="case__header__info">
          ...
          <div className="case__header__info__links">
            <Anchor href="https://github.com/patrickmao93/techdegree-project-6">
              <i className="fab fa-github" />
              View on Github
            </Anchor>
            <Anchor href="https://patrickmao93.github.io/techdegree-project-6">
